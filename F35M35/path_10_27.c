...
void Tnit_Bez_test(void)
{
    ...
    Bez.Tar_Points[4][0] = 0.56270;
    Bez.Tar_Points[4][1] = 0.10544;
    Bez.Tar_Points[4][2] = 0.35582;

    Bez.Tar_Points[6][0] = 0.50712;
    Bez.Tar_Points[6][1] = 0.50000;
    Bez.Tar_Points[6][2] = 0.32068;

    Bez.Tar_Points[8][0] = 0.49322;
    Bez.Tar_Points[8][1] = 0.59864;
    Bez.Tar_Points[8][2] = 0.31189;
    ...
    Bez.Tar_Points[18][2] = 0.24706;

    Bez.Tar_Points[20][0] = 0.09841;
    Bez.Tar_Points[20][1] = 0.59864;
    Bez.Tar_Points[20][2] = 0.06223;

    Bez.Tar_Points[22][0] = 0.08452;
    Bez.Tar_Points[22][1] = 0.50000;
    Bez.Tar_Points[22][2] = 0.05345;

    Bez.Tar_Points[24][0] = 0.04283;
    Bez.Tar_Points[24][1] = 0.20408;
    Bez.Tar_Points[24][2] = 0.02709;
